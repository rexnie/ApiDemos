...
public class RemoteService extends Service {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case REPORT_MSG: {
                    ...
                    for (int i = 0; i < N; i++) {
                        try {
                            Log.d(TAG, "service valueChanged, value=" + value);
    ...
    public static class Binding extends Activity {
        ...
        private IRemoteServiceCallback mCallback = new IRemoteServiceCallback.Stub() {
            ...
            public void valueChanged(int value) {
                Log.d(TAG, "client valueChanged, value=" + value);
    ...
    public static class BindingOptions extends Activity {
        ...
        TextView mCallbackText;
        Intent mBindIntent;
        tandard initialization = new activity.Set
        up priv;
        the UI, then
        the user
        to poke
...

        {
            ...
            of this private OnClickListener mBindAboveClientListener = new OnClickListener() {
            public void onClick(View v) {
                if (mCurConnection != null) {
                    unbindService(mCurConnection);
                    mCurConnection = null;
            ...
            ate OnClickListener mBindAllowOomListener = new OnClickListener() {
            public void onClick(View v) {
                if (mCurConnection != null) {
                    unbindService(mCurConnection);
                    mCurConnection = null;
            ...
            rivate OnClicistener mBindWithActivityListener = new OnClickListener() {
            public void onClick(View v) {
                if (mCurConnection != null) {
                    unbindService(mCurConnection);
                    mCurConnection = null;
        ...
        private OnClickL
        onnection implements ServiceConnection
        ...
        class MyServiceC SkListener mBindNormalListener
    }

/**
 * istener mUnbindListener = new OnClickListener() {
 * public void onClick(View v) {
 * if (mCurConnection != null) {
 * unbindService(mCurConnection);
 * mCurConnection = null;
